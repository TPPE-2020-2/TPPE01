...
class SequenceDiagramHelper:

  def sequence_diagram_menu(self, sequence_diagram):
      util.clear()
      lifelines = self.get_lifelines()
      ...
      while True:
          ...
          if user_in == '1':
              sequence_diagram.set_messages(self.add_message(lifelines))
          elif user_in == '2':
              sequence_diagram.set_fragments(self.add_fragment())
          elif user_in == '3':
  ...
  def add_message(self, lifelines):
      ...
      self.print_lifelines(lifelines)
      try:
